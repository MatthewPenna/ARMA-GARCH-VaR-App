...
def run_backtest(ticker, start_date, window_size, windows, VaR_quantile):
    ...
    if n_returns < min_needed:
        msg = (
            "Not enough data for chosen window settings. Restart the page and try again\n"
        ...
        # return one error dict for each model: NTS, t, Normal
        return error_dict, error_dict, error_dict
